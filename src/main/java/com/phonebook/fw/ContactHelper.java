...
public class ContactHelper extends BaseHelper{
    ...
    public boolean isContactCreated(String text) {
        List<WebElement> contacts = ApplicationManager.driver.findElements(By.cssSelector("h2")); //alt ent introduce new variable (driver.findelem)

        for(WebElement element: contacts){ //перебор элентов
